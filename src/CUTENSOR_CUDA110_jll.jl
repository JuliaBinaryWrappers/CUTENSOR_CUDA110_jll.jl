...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUTENSOR_CUDA110_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("004fe424-f3b5-51a0-a814-026e7c39908e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUTENSOR_CUDA110", artifacts_toml) for e in artifacts["CUTENSOR_CUDA110"]]
...
if best_platform === nothing
    @debug("Unable to load CUTENSOR_CUDA110; unsupported platform $(triplet(platform_key_abi()))")
else
